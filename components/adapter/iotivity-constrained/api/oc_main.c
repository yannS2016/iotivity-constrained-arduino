...
static int _OC_MTU_SIZE = 2048 + COAP_MAX_HEADER_SIZE;
static int _OC_MAX_APP_DATA_SIZE = 8192;
static int _OC_BLOCK_SIZE = 1024;

int
oc_set_mtu_size(int mtu_size)
{
#ifdef OC_BLOCK_WISE
...
void
oc_set_max_app_data_size(int size)
{
